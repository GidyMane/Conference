...
<head>
    <meta charset="UTF-8">
    <title>KALRO Password Reset</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<div class="container">
    ...
    <div class="content">
        ...
        <p>
            ...
            Please find your new temporary login details below.
        </p>
        ...
        <p>
            If you did not request this reset, please contact support immediately.<br>
            Regards,<br>
            <strong>KALRO Conference Team</strong>
        </p>
    </div>
