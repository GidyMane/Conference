    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            @if($registration->payment_status === 'pending')
                ...
                <form action="{{ route('finance.registrations.approve', $registration->id) }}"
        ...
        <div class="row">
            ...
            @if($registration->payment_proof_path)
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('finance.registrations.downloadProof', ['id' => $registration->id, 'type' => 'payment']) }}"
            ...
            @if($registration->student_id_path)
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('finance.registrations.downloadProof', ['id' => $registration->id, 'type' => 'student']) }}"
...
<div class="modal fade" id="rejectModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('finance.registrations.reject', $registration->id) }}"
                  method="POST">
                @csrf
