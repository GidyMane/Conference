    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            @if($group->payment_status === 'pending')
                <form action="{{ route('admin.groupRegistrations.approve', $group->id) }}"
...
<div class="card mt-3 shadow-sm">
    ...
    <div class="card-body text-center">
        ...
        <div class="mt-2">
            <a href="{{ route('admin.groupRegistrations.downloadProof', $group->id) }}"
...
<div class="modal fade" id="rejectModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.groupRegistrations.reject', $group->id) }}"
                  method="POST">
                @csrf
