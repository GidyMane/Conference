...
<head>
    ...
    <style>
        :root {
            --kalro-green: #2d8a3e;
            --kalro-dark-green: #1f6129;
            --kalro-light-green: #e8f5e9;
            --sidebar-width: 260px;
        }
        ...
        .sidebar {
            ...
            background: linear-gradient(180deg, var(--kalro-green) 0%, var(--kalro-dark-green) 100%);
            color: white;
            overflow-y: auto;
            transition: all 0.3s;
            z-index: 1000;
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <h4><i class="fas fa-leaf"></i> KALRO Conference</h4>
            <p>Admin Portal</p>
        </div>
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{route('admin.abstracts.index')}}" class="menu-item {{ request()->routeIs('admin.abstracts.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.fullpapers.completed') }}"
   class="menu-item {{ request()->routeIs('admin.fullpapers.completed') ? 'active' : '' }}">
