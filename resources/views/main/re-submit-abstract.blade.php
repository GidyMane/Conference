            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="display-5 fw-bold mb-3">
                        <i class="fas fa-paper-plane me-3"></i>Abstract Resubmission
                    </h1>
                ...
                <div class="col-12">
                    <div class="alert alert-info border-0">
                        <div class="d-flex">
                            ...
                            <div>
                                <h5 class="alert-heading mb-2">Resubmission Guidelines</h5>
                                <ul class="mb-0">
                    ...
                    <div class="form-card p-4 p-md-5 rounded shadow-sm">
                        <div class="text-center mb-5">
                            <h2 class="h1 mb-3 text-success">
                                <i class="fas fa-file-alt me-2"></i>Abstract Resubmission Form
                            </h2>
