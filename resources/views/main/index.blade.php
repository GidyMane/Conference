...
<section class="cta-section text-center py-5">
    <div class="container position-relative" style="z-index:2;">
        ...
        <p class="lead text-white mb-5 mx-auto opacity-90" style="max-width:820px;">
            Whether your goal is to gain new knowledge, showcase innovative solutions, or present research,
            the KALRO Scientific Conference offers an opportunity to participate and make an impact.
        </p>
