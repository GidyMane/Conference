                                ...
                                <div class="row g-4">
                                    <div class="col-12">
                                        <div class="input-group-modern">
                                            ...
                                            <div class="input-icon"><i class="bi bi-check-circle-fill"></i></div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group-modern">
                                            ...
                                            <div class="char-counter"><span class="current">0</span> / 50 minimum</div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group-modern">
                                            ...
                                            <textarea class="form-control form-control-lg" id="benefits"
                                                      ...
                                                      placeholder="What will attendees gain from visiting your booth?"
                                ...
                                <div class="row g-4">
                                    <div class="col-12">
                                        <label class="form-label section-label">
                                            <i class="bi bi-grid-3x3 me-2"></i>How many booths do you need?
                                        </label>
                                        <div class="booth-counter-card">
                                            <div class="counter-wrapper">
                                                <button type="button" class="counter-btn decrement" id="decrementBooth" aria-label="Decrease booth quantity">
                                                    <span class="symbol">&#8722;</span>
                                                </button>
                                                <div class="counter-display">
                                                    <input type="number" class="form-control" id="boothCount" name="boothCount"
                                                           min="1" max="10" value="{{ old('boothCount', 1) }}" required readonly>
                                                    <span class="counter-label">Booth Selected</span>
                                                </div>
                                                <button type="button" class="counter-btn increment" id="incrementBooth" aria-label="Increase booth quantity">
                                                    <span class="symbol">&#43;</span>
                                                </button>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <label class="form-label section-label">
                                            <i class="bi bi-cup-hot me-2"></i>Choose Your Package <span class="required">*</span>
                                        </label>
                                        <div class="package-cards">
                                            <label class="package-card">
                                                ...
                                                <div class="package-content">
                                                    <div class="package-icon"><i class="bi bi-cup-hot-fill"></i></div>
                                                    <h4 class="package-title">Premium Package</h4>
                                                    <div class="package-features">
                                                        <div class="feature-item included"><i class="bi bi-check-circle-fill text-success"></i><span>Booth space with furniture</span></div>
                                                        <div class="feature-item included"><i class="bi bi-check-circle-fill text-success"></i><span>2 exhibitor registrations</span></div>
                                                        <div class="feature-item included highlight-feature"><i class="bi bi-check-circle-fill text-success"></i><span><strong>Full catering included</strong></span></div>
                                                        <div class="feature-item included"><i class="bi bi-check-circle-fill text-success"></i><span>Conference materials</span></div>
                                                    </div>
                                            ...
                                            <label class="package-card">
                                                ...
                                                <div class="package-content">
                                                    <div class="package-icon"><i class="bi bi-shop-window"></i></div>
                                                    <h4 class="package-title">Standard Package</h4>
                                                    <div class="package-features">
                                                        <div class="feature-item included"><i class="bi bi-check-circle-fill text-success"></i><span>Booth space with furniture</span></div>
                                                        <div class="feature-item included"><i class="bi bi-check-circle-fill text-success"></i><span>2 exhibitor registrations</span></div>
                                                        <div class="feature-item excluded"><i class="bi bi-x-circle-fill text-danger"></i><span>Meals not included</span></div>
                                                        <div class="feature-item included"><i class="bi bi-check-circle-fill text-success"></i><span>Conference materials</span></div>
                                                    </div>
                                                    <div class="package-price">
                                                        <span class="currency">KES</span>
  ...
  <rect x="16" y="14" width="3" height="2" rx=".5" fill="currentColor" opacity=".4"/>
                            ...
                            <div class="step-content">
                                <div class="row g-4">
                                    <div class="col-12">
                                        <label class="form-label section-label">
                                            <i class="bi bi-wallet2 me-2"></i>Select Payment Method <span class="required">*</span>
                                        </label>
                                    ...
                                    <!-- =============================================
                                         BANK DETAILS — corrected order & branch name
                                    ============================================== -->
                                    <div class="col-12">
                            ...
                            <div class="step-footer">
                                ...
                                <button type="button" class="btn btn-primary btn-lg btn-next">
                                    Continue to Contact Info <i class="bi bi-arrow-right ms-2"></i>
                                </button>
                            </div>
                        </div>
  ...
  <path d="M4 20c0-4.418 3.582-8 8-8s8 3.582 8 8" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" fill="none"/>
                            ...
                            <div class="step-content">
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="input-group-modern">
                                            <label for="contactName" class="form-label">
                                                <i class="bi bi-person-fill me-2"></i>Full Name <span class="required">*</span>
                                            </label>
                                            <input type="text" class="form-control form-control-lg"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group-modern">
                                            <label for="contactRole" class="form-label">
                                                <i class="bi bi-briefcase-fill me-2"></i>Role/Position <span class="required">*</span>
                                            </label>
                                            <input type="text" class="form-control form-control-lg"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group-modern">
                                            <label for="contactPhone" class="form-label">
                                                <i class="bi bi-telephone-fill me-2"></i>Phone Number <span class="required">*</span>
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group-modern">
                                            <label for="contactEmail" class="form-label">
                                                <i class="bi bi-envelope-fill me-2"></i>Email Address <span class="required">*</span>
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label section-label">
                                            <i class="bi bi-person-badge me-2"></i>Team Leader? <span class="required">*</span>
                                        </label>
                                        <div class="toggle-group">
                                            <label class="toggle-option">
                                                ...
                                                <span class="toggle-content">
                                                    <i class="bi bi-check-circle"></i><span>Yes, I'm leading</span>
                                                </span>
                                            </label>
                                            <label class="toggle-option">
                                                ...
                                                <span class="toggle-content">
                                                    <i class="bi bi-x-circle"></i><span>No, someone else</span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group-modern">
                                            <label for="teamSize" class="form-label">
                                                <i class="bi bi-people-fill me-2"></i>Team Size <span class="required">*</span>
                                            </label>
                                            <input type="number" class="form-control form-control-lg"
                                                   id="teamSize" name="teamSize" min="1" max="20"
                                                   value="{{ old('teamSize', 2) }}" required>
                                            <small class="form-hint">
                                                <i class="bi bi-info-circle me-1"></i>Note: Catering is provided for 2 persons per booth only
                                            </small>
                                        </div>
                                    </div>
                                </div>
...
.progress-line { height: 3px; flex: 1; background: var(--border-color); margin: 0 .75rem; position: relative; border-radius: 2px; overflow: hidden; }
...
.form-step { display: none !important; animation: fadeSlideIn .5s ease; padding: 2rem; }
...
/* INPUTS */
.input-group-modern { position: relative; margin-bottom: .5rem; }
.form-label { font-weight: 600; color: var(--text-dark); margin-bottom: .6rem; font-size: .9rem; display: flex; align-items: center; }
...
.form-control { border: 2px solid var(--border-color); border-radius: 10px; padding: .75rem 1rem; font-size: .95rem; transition: all .3s ease; background: white; }
.form-control-lg { padding: .85rem 1.15rem; font-size: 1rem; min-height: 48px; }
.form-control:focus { border-color: var(--kalro-primary); box-shadow: 0 0 0 3px rgba(26,95,58,.08); outline: none; }
.input-group-modern .input-icon { position: absolute; right: .85rem; top: 50%; transform: translateY(-50%); color: var(--success); opacity: 0; transition: opacity .3s ease; font-size: 1.1rem; }
.form-control:valid ~ .input-icon { opacity: 1; }
textarea.form-control { resize: vertical; min-height: 120px; }
.form-hint { display: block; margin-top: .4rem; color: var(--text-muted); font-size: .8rem; }
.char-counter { position: absolute; right: .85rem; bottom: -1.5rem; font-size: .75rem; color: var(--text-muted); font-weight: 600; }
.char-counter .current { color: var(--kalro-primary); }
...
.counter-wrapper { display: flex; align-items: center; justify-content: center; gap: 1.5rem; margin-bottom: 1rem; }
.counter-btn { width: 50px; height: 50px; border-radius: 12px; background: white; border: 2px solid var(--kalro-primary); color: var(--kalro-primary); font-size: 1.5rem; font-weight: 700; line-height: 1; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: all .3s ease; box-shadow: 0 3px 8px rgba(0,0,0,.06); user-select: none; }
...
.counter-label { display: block; margin-top: .35rem; font-size: .95rem; font-weight: 600; color: var(--kalro-dark); }
.counter-note { margin: 0; color: var(--text-muted); font-size: .85rem; }

/* PACKAGES */
.package-cards { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px,1fr)); gap: 1.5rem; }
...
.package-content { background: white; border: 2px solid var(--border-color); border-radius: 16px; padding: 1.5rem; text-align: center; transition: all .4s ease; position: relative; height: 100%; }
.package-card:hover .package-content { border-color: var(--kalro-accent); transform: translateY(-6px); box-shadow: 0 12px 30px rgba(26,95,58,.12); }
.package-card input:checked ~ .package-content { background: var(--kalro-gradient); border-color: var(--kalro-primary); transform: translateY(-8px); box-shadow: 0 15px 40px rgba(26,95,58,.25); }
.package-icon { width: 65px; height: 65px; border-radius: 16px; background: var(--kalro-light); display: inline-flex; align-items: center; justify-content: center; margin-bottom: 1rem; transition: all .4s ease; }
.package-icon i { font-size: 2rem; color: var(--kalro-primary); transition: all .4s ease; }
.package-card input:checked ~ .package-content .package-icon { background: rgba(255,255,255,.2); }
.package-card input:checked ~ .package-content .package-icon i { color: white; }
.package-title { font-size: 1.25rem; font-weight: 700; color: var(--text-dark); margin-bottom: .85rem; transition: all .4s ease; }
.package-card input:checked ~ .package-content .package-title { color: white; }
.package-price { margin-top: 12px; padding-top: 10px; border-top: 1px solid #e5e7eb; margin-bottom: 1.25rem; }
.package-price .currency { font-size: .9rem; font-weight: 600; color: var(--text-muted); transition: all .4s ease; }
.package-price .amount { font-size: 2.25rem; font-weight: 700; color: var(--kalro-primary); display: block; line-height: 1; margin: .2rem 0; transition: all .4s ease; }
.package-price .per { font-size: .8rem; color: var(--text-muted); transition: all .4s ease; }
...
.package-features { text-align: left; margin-bottom: .85rem; }
.feature-item { display: flex; align-items: center; gap: 7px; margin-bottom: 5px; font-size: .85rem; }
.feature-item.included i { color: #16a34a; }
.feature-item.excluded i { color: #dc2626; }
.highlight-feature { background: rgba(22,163,74,.08); padding: 5px 8px; border-radius: 5px; }
.feature-item span { color: var(--text-dark); font-size: .85rem; transition: all .4s ease; }
...
.selection-indicator { position: absolute; top: 1.25rem; left: 1.25rem; font-size: 1.65rem; color: var(--success); opacity: 0; transform: scale(0); transition: all .4s ease; }
.package-card input:checked ~ .package-content .selection-indicator { opacity: 1; transform: scale(1); color: white; }

/* COST SUMMARY */
.cost-summary-modern { background: white; border: 2px solid var(--kalro-primary); border-radius: 16px; overflow: hidden; box-shadow: 0 8px 20px rgba(26,95,58,.12); }
.summary-header { background: var(--kalro-gradient); color: white; padding: 1.15rem 1.5rem; display: flex; align-items: center; gap: .6rem; }
.summary-header i { font-size: 1.5rem; }
.summary-header h5 { margin: 0; font-size: 1.1rem; font-weight: 700; }
...
.summary-row .label { color: var(--text-muted); font-weight: 600; font-size: .9rem; }
.summary-row .value { color: var(--text-dark); font-weight: 700; font-size: .95rem; }
.summary-divider { height: 1.5px; background: var(--kalro-light); margin: 1rem 0; }
.summary-total { display: flex; justify-content: space-between; align-items: center; padding: 1.15rem; background: var(--kalro-light); border-radius: 10px; margin-top: .75rem; }
.summary-total .label { font-size: 1.05rem; font-weight: 700; color: var(--kalro-dark); }
.summary-total .amount { font-size: 1.85rem; font-weight: 700; color: var(--kalro-primary); }
...
.method-icon i { font-size: 1.65rem; color: var(--kalro-primary); transition: all .4s ease; }
.payment-method-card input:checked ~ .method-content .method-icon { background: rgba(255,255,255,.2); }
.payment-method-card input:checked ~ .method-content .method-icon i { color: white; }
.method-info { flex: 1; }
.method-info h5 { margin: 0 0 .2rem 0; font-size: 1.05rem; font-weight: 700; color: var(--text-dark); transition: all .4s ease; }
...
.info-header { background: var(--kalro-gradient); color: white; padding: 1.15rem 1.5rem; display: flex; align-items: center; gap: .6rem; }
.info-header i { font-size: 1.5rem; }
.info-header h5 { margin: 0; font-size: 1.1rem; font-weight: 700; }
.info-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px,1fr)); gap: 0; padding: 1.5rem; }
.info-grid.simple { grid-template-columns: repeat(auto-fit, minmax(180px,1fr)); }
.info-item { display: flex; flex-direction: column; gap: .4rem; padding: 1rem; border-bottom: 1px solid #f0f0f0; border-right: 1px solid #f0f0f0; }
.info-item:nth-child(2n) { border-right: none; }
.info-item.highlight { background: var(--kalro-light); border-radius: 10px; margin: .4rem; border: 2px solid var(--kalro-accent); }
.info-label { font-size: .8rem; color: var(--text-muted); font-weight: 600; }
.info-value { font-size: .95rem; color: var(--text-dark); font-weight: 700; }
.info-value.large { font-size: 1.25rem; color: var(--kalro-primary); }
.mpesa-steps { padding: 1.25rem 1.5rem; background: var(--bg-light); border-top: 2px solid var(--border-color); }
.mpesa-steps h6 { color: var(--kalro-dark); font-weight: 700; margin-bottom: .75rem; font-size: .95rem; }
.mpesa-steps ol { margin: 0; padding-left: 1.25rem; }
.mpesa-steps li { padding: .4rem 0; color: var(--text-dark); font-size: .85rem; }
...
.upload-area i { font-size: 2.5rem; color: var(--kalro-primary); display: block; margin-bottom: .75rem; }
.upload-text { display: block; font-weight: 600; color: var(--kalro-primary); margin-bottom: .4rem; font-size: .9rem; }
...
/* TOGGLE */
.toggle-group { display: flex; gap: .85rem; }
.toggle-option { flex: 1; cursor: pointer; }
.toggle-option input[type="radio"] { display: none; }
.toggle-content { display: flex; align-items: center; justify-content: center; gap: .6rem; padding: .85rem 1.15rem; background: white; border: 2px solid var(--border-color); border-radius: 10px; font-weight: 600; color: var(--text-dark); transition: all .3s ease; font-size: .9rem; }
.toggle-content i { font-size: 1.25rem; color: var(--text-muted); transition: all .3s ease; }
...
.terms-card { background: var(--kalro-light); border: 2px solid var(--kalro-accent); border-radius: 12px; padding: 1.35rem; }
...
.step-footer.final { justify-content: space-between; }
...
/* RESPONSIVE */
@media (max-width: 992px) { .form-step { padding: 2rem 1.5rem; } .package-cards, .info-grid { grid-template-columns: 1fr; } .info-item { border-right: none; } }
@media (max-width: 768px) { .step-circle { width: 50px; height: 50px; } .step-icon i { font-size: 1.25rem; } .step-label { font-size: .7rem; } .progress-line { margin: 0 .4rem; } .form-step { padding: 1.5rem 1.25rem; } .step-footer, .toggle-group { flex-direction: column; } .step-footer .btn { width: 100%; min-width: unset; } .payment-method-cards { grid-template-columns: 1fr; } }
@media (max-width: 576px) { .exhibition-hero { padding: 2.5rem 0 3.5rem; } .exhibition-hero h1 { font-size: 1.75rem; } .step-icon-large { width: 60px; height: 60px; } .step-icon-large i { font-size: 1.75rem; } .step-title { font-size: 1.35rem; } .counter-btn { width: 45px; height: 45px; } .package-price .amount { font-size: 2rem; } }
</style>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showStep(step) {
        formSteps.forEach(s => { s.classList.remove('active'); s.style.display = 'none'; });
        const cur = document.querySelector(`.form-step[data-step="${step}"]`);
        if (cur) { cur.classList.add('active'); cur.style.display = 'block'; }
    ...
    function validateStep(step) {
        const cur = document.querySelector(`.form-step[data-step="${step}"]`);
        const inputs = cur.querySelectorAll('input[required]:not([type="radio"]), select[required], textarea[required]');
        let valid = true;
        inputs.forEach(inp => {
            if (!inp.value.trim()) {
                valid = false; inp.classList.add('is-invalid');
                if (!inp.nextElementSibling?.classList.contains('invalid-feedback')) {
                ...
                inp.parentNode.querySelector('.invalid-feedback')?.remove();
            }
        });
        const radioGroups = {};
        cur.querySelectorAll('input[type="radio"][required]').forEach(r => {
            if (!radioGroups[r.name]) radioGroups[r.name] = cur.querySelector(`input[name="${r.name}"]:checked`);
        });
        Object.values(radioGroups).forEach(c => { if (!c) valid = false; });
        if (step === 1) {
            if (aboutExhibition.value.trim().length < 50) { valid = false; aboutExhibition.classList.add('is-invalid'); }
    ...
    nextBtns.forEach(btn => { btn.addEventListener('click', () => { if (validateStep(currentStep) && currentStep < totalSteps) { currentStep++; showStep(currentStep); } }); });
    ...
    aboutExhibition?.addEventListener('input', function() { updateCharCounter(this); });
    benefits?.addEventListener('input', function() { updateCharCounter(this); });

    incrementBtn?.addEventListener('click', () => {
        const cur = parseInt(boothCountInput.value) || 1;
        if (cur < 10) { boothCountInput.value = cur + 1; updateBoothLabel(); updateCostSummary(); }
    });
    decrementBtn?.addEventListener('click', () => {
        const cur = parseInt(boothCountInput.value) || 1;
        if (cur > 1) { boothCountInput.value = cur - 1; updateBoothLabel(); updateCostSummary(); }
    });
    ...
    function updateBoothLabel() {
        ...
        if (label) label.textContent = count === 1 ? 'Booth Selected' : 'Booths Selected';
    }
    ...
    registrationTypeRadios?.forEach(r => r.addEventListener('change', updateCostSummary));
    ...
    function setupFileUpload(uploadId, inputId) {
        ...
        const placeholder = area.querySelector('.upload-area');
        const preview = area.querySelector('.file-preview-modern');
        ...
        area.addEventListener('click', e => { if (!e.target.closest('.file-remove')) input.click(); });
        area.addEventListener('dragover', e => { e.preventDefault(); placeholder?.classList.add('dragging'); });
        area.addEventListener('dragleave', () => placeholder?.classList.remove('dragging'));
        area.addEventListener('drop', e => { e.preventDefault(); placeholder?.classList.remove('dragging'); if (e.dataTransfer.files.length) { input.files = e.dataTransfer.files; handleFile(input.files[0]); } });
        input.addEventListener('change', function() { if (this.files?.[0]) handleFile(this.files[0]); });
        function handleFile(file) {
            if (fileNameSpan && fileSizeSpan && placeholder && preview) {
                fileNameSpan.textContent = file.name;
                const b = file.size; fileSizeSpan.textContent = b < 1024 ? b + ' B' : b < 1048576 ? (b/1024).toFixed(1) + ' KB' : (b/1048576).toFixed(1) + ' MB';
                placeholder.style.display = 'none'; preview.style.display = 'flex';
            }
        }
        removeBtn?.addEventListener('click', e => { e.stopPropagation(); input.value = ''; if (placeholder && preview) { preview.style.display = 'none'; placeholder.style.display = 'block'; } });
    }
