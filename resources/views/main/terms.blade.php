        ...
        <div class="terms-card">
            ...
            <div class="terms-section">
                <div class="section-header">
                    ...
                    <h3 class="section-title">Registration for the Conference and Exhibition</h3>
                </div>
                <div class="section-content">
            ...
            <div class="terms-section">
                ...
                <div class="section-content">
                    <div class="subsection">
                        <div class="subsection-point">
                            <span class="point-marker">i)</span>
                            <p>Virtual participants must use the official conference platform for access.</p>
                        </div>
                        <div class="subsection-point">
                            <span class="point-marker">ii)</span>
                            <p>Technical support will be provided during conference hours to assist attendees with platform-related concerns; however, the organizers do not guarantee resolution of all technical issues, particularly those related to personal device failures or external service disruptions.</p>
                        </div>
                        <div class="subsection-point">
                            <span class="point-marker">iii)</span>
                            <p>Virtual attendees are responsible for ensuring their internet connectivity and device functionality. While technical support may be available, conference organizers do not guarantee resolution of individual technical issues.</p>
                        </div>
                        <div class="subsection-point">
                            <span class="point-marker">iv)</span>
                            <p>Organizers are not liable for disruptions caused by platform outages or personal device failures.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="terms-section">
                ...
                <div class="section-content">
                    <div class="subsection">
                        <div class="subsection-point">
                            <span class="point-marker">i)</span>
                            <p>All presentations and materials remain the intellectual property of their respective authors.</p>
                        </div>
                        <div class="subsection-point">
                            <span class="point-marker">ii)</span>
                            <p>No unauthorized distribution, reproduction, or modification of conference content is allowed.</p>
                        </div>
                        <div class="subsection-point">
                            <span class="point-marker">iii)</span>
                            <p>Speakers may provide materials for sharing at their discretion.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="terms-section">
                ...
                <div class="section-content">
                    <div class="subsection">
                        <div class="subsection-point">
                            <span class="point-marker">i)</span>
                            <p>The conference strives to be inclusive, offering accessibility features such as captions and assistive technologies.</p>
                        </div>
                        <div class="subsection-point">
                            <span class="point-marker">ii)</span>
                            <p>Attendees requiring special access should notify the organizers in advance.</p>
                        </div>
                    </div>
                </div>
            </div>
