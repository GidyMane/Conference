...
@section('page-title', 'Presentation Materials')

@section('content')
<style>
    .materials-header {
        background: linear-gradient(135deg, #1e5a96 0%, #143d66 100%);
        color: white;
        padding: 24px;
        border-radius: 12px;
        margin-bottom: 24px;
        box-shadow: 0 4px 12px rgba(30, 90, 150, 0.2);
    }
    ...
    <div class="materials-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="mb-0 opacity-75">View author-submitted presentation files</p>
            </div>
            <div>
                <a href="{{ url('/reviewer/fullpapers-review') }}" class="btn btn-light">
