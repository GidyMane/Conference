                ...
                <div class="col-lg-1 col-md-4 col-6">
                    <div class="logo">
                        <a href="<?php echo BASE_URL; ?>">
                            <img src="<?php echo ASSETS_URL; ?>images/kalro-logo.gif" alt="KALRO Logo" class="img-fluid kalro-logo">
                        </a>
                    </div>
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark kalro-nav">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>pages/conference_theme.php">Conference Theme</a></li>
                            <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>pages/conference_procedure.php">Conference Procedure</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo BASE_URL; ?>pages/submit_abstract.php">
                            <i class="fas fa-paper-plane me-1"></i> Submit Abstract
                        </a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo BASE_URL; ?>pages/contact.php">
                ...
                <!-- Register Button -->
                <div class="d-flex">
                    <a href="<?php echo BASE_URL; ?>pages/submit_abstract.php" class="btn btn-warning btn-sm">
