...
require BASE_PATH . 'mailer/src/Exception.php';
require BASE_PATH . 'mailer/src/PHPMailer.php';
require BASE_PATH . 'mailer/src/SMTP.php';
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'sepdconference@gmail.com'; // keep as is
        $mail->Password = 'mnsv mvcy bduh jbrk';       // keep as is
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;

        $mail->setFrom('sepdconference@gmail.com', 'KALRO Conference');
        $mail->addAddress('morrisoh@gmail.com');
