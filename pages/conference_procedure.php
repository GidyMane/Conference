...
$page_title = "Conference Procedure";
            ...
            <div class="col-lg-10 mx-auto">
                <div class="text-center p-5 rounded bg-success text-white">
                    ...
                    <div class="d-flex justify-content-center flex-wrap gap-3">
                        <a href="<?php echo BASE_URL; ?>pages/submit_abstract.php" class="btn btn-light btn-lg">
                            <i class="fas fa-paper-plane me-1"></i>Submit Abstract
                        </a>
                       
                        <a href="<?php echo BASE_URL; ?>pages/contact.php" class="btn btn-warning btn-lg">
