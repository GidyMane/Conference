        ...
        <div class="row align-items-center mb-5">
            <div class="col-lg-8">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <a href="<?php echo BASE_URL; ?>pages/submit_abstract.php" class="btn btn-outline-success btn-lg">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                ...
                <div class="mt-4">
                    <a href="<?php echo BASE_URL; ?>pages/venue.php" class="btn btn-success">
            ...
            <div class="col-lg-6">
                <div class="venue-map shadow rounded overflow-hidden">
                    <img src="<?php echo ASSETS_URL; ?>images/kalrohq.jpg" alt="Conference Venue" class="img-fluid w-100">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <div class="d-flex justify-content-center gap-3 flex-wrap">
                    <a href="<?php echo BASE_URL; ?>pages/submit_abstract.php" class="btn btn-light btn-lg px-5">
                        <i class="fas fa-user-plus me-2"></i>Submit Abstract Now
                    </a>
                    <a href="<?php echo BASE_URL; ?>pages/contact.php" class="btn btn-outline-light btn-lg px-5">
