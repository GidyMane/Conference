...
$submitted = isset($_GET['success']) && $_GET['success'] == 'true';
?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="form-card p-4 p-md-5 rounded shadow-sm">
                    ...
                    <form id="abstractForm" method="POST" action="save_abstract.php" novalidate>
                        <input type="hidden" name="submission_id" value="<?php echo uniqid('KALRO_'); ?>">
