                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                <a href="<?php echo BASE_URL; ?>pages/submit_abstract.php" class="btn btn-success btn-lg">
                                    <i class="fas fa-paper-plane me-2"></i>Submit Abstract
                                </a>
                                <a href="<?php echo BASE_URL; ?>pages/about.php" class="btn btn-outline-info btn-lg">
