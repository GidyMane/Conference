        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="<?php echo BASE_URL; ?>" class="text-white-50">Home</a></li>
                    <li class="mb-2"><a href="<?php echo BASE_URL; ?>pages/about.php" class="text-white-50">About</a></li>
                    <li class="mb-2"><a href="<?php echo BASE_URL; ?>pages/conference_theme.php" class="text-white-50">Conference Theme</a></li>
                    <li class="mb-2"><a href="<?php echo BASE_URL; ?>pages/conference_procedure.php" class="text-white-50">Procedure</a></li>
                    <li class="mb-2"><a href="<?php echo BASE_URL; ?>pages/submit_abstract.php" class="text-white-50">Submit Abstract</a></li>
                </ul>
            </div>
